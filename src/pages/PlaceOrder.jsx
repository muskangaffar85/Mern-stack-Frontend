  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      switch (method) {
        ...
        case 'cod':
          const response = await axios.post('https://backend-ecommerce-zeta-neon.vercel.app/api/order/place', orderData, {
            headers: {
        ...
        case 'stripe':
          const responseStripe = await axios.post('https://backend-ecommerce-zeta-neon.vercel.app/api/order/stripe', orderData, {
            headers: {
              Authorization: `Bearer ${token}`
            }
          });
